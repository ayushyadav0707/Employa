...
export default function AvatarDropdown() {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        <div className="h-9 w-9 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 font-bold text-sm border-2 border-transparent hover:border-indigo-300 transition-colors shadow-sm">
          A
        </div>
      </button>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-lg border border-gray-100 py-1 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
          <div className="px-4 py-2 border-b border-gray-100 mb-1">
            ...
            <p className="text-xs text-gray-500 truncate">admin@dayflow.com</p>
          </div>
          <Link 
            href="/profile" 
